...
if(!password){console.log('ADMIN_PASSWORD is not set; administrator provisioning skipped.');await db.end();process.exit(0);}
if(password.length<10){console.error('ADMIN_PASSWORD must contain at least 10 characters.');await db.end();process.exit(1);}
